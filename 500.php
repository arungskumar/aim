...
<body>
 <div class="error-page login-wrap bg-cover height-100-p customscroll d-flex align-items-center flex-wrap justify-content-center pd-20">
  <img src="vendors/images/carousal.jpg" alt="" class="bg_img">
  <div class="pd-10">
   <div class="error-page-wrap text-center color-white">
	...
	<p>An error ocurred and your request couldn’t be completed..<br>Either check the URL, <a href="index.php">go home</a>.</p>
   </div>
  </div>
 </div>
