...
<html>
<head>
 <title>Application Infrastructure Manager</title>
     ...
     <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
	  ...
	  <div class="carousel-inner">
	   <div class="carousel-item active">
		<img class="d-block w-100 mCS_img_loaded" src="vendors/images/carousel.jpg" alt="First slide">
		...
		<h5 class="color-white">Application Hosting</h5>
		<p>.</p>
		</div>
 	   </div>
       <div class="carousel-item">
		<img class="d-block w-100 mCS_img_loaded" src="vendors/images/carousel.jpg" alt="Second slide">
		<div class="carousel-caption d-none d-md-block">
		 <h5 class="color-white">Compute</h5>
		 <p>.</p>
		</div>
  	   </div>
       <div class="carousel-item">
		<img class="d-block w-100 mCS_img_loaded" src="vendors/images/carousel.jpg" alt="Third slide">
		<div class="carousel-caption d-none d-md-block">
		 <h5 class="color-white">Database</h5>
		 <p>.</p>
		</div>
	   </div>
       <div class="carousel-item">
		<img class="d-block w-100 mCS_img_loaded" src="vendors/images/carousel.jpg" alt="Fourth slide">
		<div class="carousel-caption d-none d-md-block">
		 <h5 class="color-white">Network</h5>
		 <p>.</p>
		</div>
	   </div>
	  </div>
